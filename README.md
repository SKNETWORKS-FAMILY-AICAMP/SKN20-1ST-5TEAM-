...
### 🚗 프로젝트 주제
- 친환경 차량과 비친 환경 차량의 10년간 변화 추이 신규 등록 추이
...
## 🔹 **메인화면**
- ![alt text](<./산출물/streamlit_캡쳐/streamlit main.png>)
## 🔹 **대시보드 분석**
  ![alt text](./산출물/streamlit_캡쳐/streamlit2.png)
## 🔹 **그래프 분석**
  ![alt text](./산출물/streamlit_캡쳐/streamlit3.png)
  ![alt text](./산출물/streamlit_캡쳐/streamlit4.png)
  ![alt text](./산출물/streamlit_캡쳐/streamlit5.png)
  ![alt text](./산출물/streamlit_캡쳐/streamlit6.png)
  ![alt text](./산출물/streamlit_캡쳐/streamlit7.png)
## 🔹 **고급 데이터 분석**
  ![alt text](./산출물/streamlit_캡쳐/streamlit8.png)
## 🔹 **FAQ**
  ![alt text](<./산출물/streamlit_캡쳐/현대  기아.png>)
  ![alt text](<./산출물/streamlit_캡쳐/현대 기아2.png>)

## 💭 한줄 회고
😀 박찬 : 팀원들과 첫 프로젝트를 진행하였는데, 다들 서로 배려해 주시고 좋은 사람들과 같이 작업할 수 있어서 좋았습니다. 수업 시간에 배운 부분들을 프로젝트에 잘 녹여낼 수 있어서 좋았고, 다들 고생하셨습니다.
...
😎 조준상 : 할 줄 아는가와 할 수 있는가의 차이가 너무 컸습니다.
...
🤔 이경현 : 첫 프로젝트를 하면서 많은 한계를 느끼고 더 많은 공부가 필요하다는 걸 느꼈습니다. 그리고 많은 배려해 주신 팀원들에게 감사합니다. 팀원들 도움으로 프로젝트를 마무리할 수 있었습니다.
